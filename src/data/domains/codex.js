...
export const codex = {
  ...
  cards: [
    // ── Level 1 (3 cards) ──────────────────────────────
    {
      ...
      activationType: 'action', cost: { type: 'hope', amount: 1 }, frequency: 'atWill', range: 'melee', trait: 'spellcast'
    },
    {
      ...
      type: 'grimoire',
      recallCost: 2,
      tags: ['offensif','social','utilitaire'],
      feature:
      ...
      activationType: 'action', cost: { type: 'hope', amount: 1 }, frequency: 'oncePerShortRest', range: 'veryClose', trait: 'spellcast'
    },
    {
    ...
    // ── Level 2 (2 cards) ──────────────────────────────
    {
      ...
      activationType: 'action', cost: { type: 'hope', amount: 2 }, frequency: 'atWill', range: 'melee', trait: 'spellcast'
    },
    {
      ...
      activationType: 'action', cost: { type: 'hope', amount: 1 }, frequency: 'oncePerShortRest', range: 'melee', trait: 'spellcast'
    },
    ...
    // ── Level 4 (2 cards) ──────────────────────────────
    {
      ...
      activationType: 'action', cost: { type: 'hope', amount: 1 }, frequency: 'oncePerShortRest', trait: 'spellcast'
    },
    {
      ...
      activationType: 'action', cost: { type: 'hope', amount: 1 }, frequency: 'oncePerLongRest', range: 'veryClose', trait: 'spellcast'
    },
    ...
    // ── Level 5 (2 cards) ──────────────────────────────
    {
      ...
      activationType: 'action', cost: { type: 'hope', amount: 1 }, frequency: 'oncePerShortRest', range: 'far', trait: 'spellcast'
    },
    {
      id: 'codex-teleport',
      name: 'Teleport',
    ...
    // ── Level 6 (2 cards) ──────────────────────────────
    {
      ...
      activationType: 'action', cost: { type: 'stress', amount: 1 }, frequency: 'oncePerShortRest', range: 'close', trait: 'spellcast'
    },
    {
      ...
      activationType: 'action', cost: { type: 'free', amount: 0 }, frequency: 'atWill', range: 'close', trait: 'spellcast'
    },
    ...
    // ── Level 7 (2 cards) ──────────────────────────────
    {
      ...
      activationType: 'action', cost: { type: 'free', amount: 0 }, frequency: 'oncePerLongRest', range: 'close', trait: 'spellcast'
    },
    {
      ...
      activationType: 'action', cost: { type: 'stress', amount: 1 }, frequency: 'oncePerShortRest'
    },
    ...
    // ── Level 8 (2 cards) ──────────────────────────────
    {
      ...
      activationType: 'action', cost: { type: 'hope', amount: 1 }, frequency: 'oncePerLongRest', range: 'far', trait: 'spellcast'
    },
    {
      id: 'codex-safe-haven',
      name: 'Safe Haven',
    ...
    },
    {
      ...
      activationType: 'action', cost: { type: 'stress', amount: 1 }, frequency: 'oncePerLongRest', range: 'far', trait: 'spellcast'
    },
    ...
    // ── Level 10 (2 cards) ─────────────────────────────
    {
      ...
      activationType: 'action', cost: { type: 'hope', amount: 5 }, frequency: 'atWill', range: 'far', trait: 'spellcast'
    },
    {
      ...
      activationType: 'action', cost: { type: 'hope', amount: 5 }, frequency: 'oncePerLongRest', trait: 'spellcast'
    }
  ]
}
