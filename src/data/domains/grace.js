...
export const grace = {
  ...
  cards: [
    ...
    },
    {
      ...
      activationType: 'action', cost: { type: 'stress', amount: 1 }, frequency: 'oncePerShortRest', range: 'far'
    },
    ...
    // ── Level 6 (2 cards) ──────────────────────────────
    {
      ...
      activationType: 'reaction', cost: { type: 'stress', amount: 1 }, frequency: 'atWill', trigger: 'Quand vous marquez 1 ou plusieurs points de vie suite à une attaque'
    },
    {
      ...
      activationType: 'action', cost: { type: 'free', amount: 0 }, frequency: 'oncePerShortRest', range: 'melee', trait: 'spellcast'
    },
    ...
    // ── Level 7 (2 cards) ──────────────────────────────
    {
      ...
      activationType: 'reaction', cost: { type: 'hope', amount: 1 }, frequency: 'atWill'
    },
    {
