...
export const midnight = {
  ...
  cards: [
    ...
    },
    {
      ...
      activationType: 'action', cost: { type: 'stress', amount: 1 }, frequency: 'atWill', trait: 'spellcast'
    },
    ...
    },
    {
      ...
      activationType: 'action', cost: { type: 'free', amount: 0 }, frequency: 'atWill', range: 'veryClose', trait: 'spellcast'
    },
    ...
    // ── Level 3 (2 cards) ──────────────────────────────
    {
      ...
      activationType: 'reaction', cost: { type: 'stress', amount: 1 }, frequency: 'atWill', trigger: 'Quand vous vous positionnez derrière une créature à peu près de votre taille'
    },
    {
    ...
    // ── Level 4 (2 cards) ──────────────────────────────
    {
      ...
      activationType: 'reaction', cost: { type: 'stress', amount: 1 }, frequency: 'atWill', range: 'close'
    },
    {
    ...
    },
    {
      ...
      activationType: 'action', cost: { type: 'stress', amount: 1 }, frequency: 'atWill', range: 'close', trait: 'spellcast'
    },
    ...
    // ── Level 7 (2 cards) ──────────────────────────────
    {
      ...
      activationType: 'reaction', cost: { type: 'stress', amount: 1 }, frequency: 'oncePerShortRest', trigger: 'Quand 4 ou plus des cartes de domaine de votre équipement sont du domaine midnight'
    },
    {
    ...
    },
    {
      ...
      activationType: 'reaction', cost: { type: 'free', amount: 0 }, frequency: 'atWill', range: 'far', trigger: 'Quand vous infligez des dégâts à cette cible'
    },
