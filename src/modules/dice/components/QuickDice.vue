...
.quick-btn {
  ...
  border: 2px solid var(--die-color, var(--color-border));
  border-radius: 8px;
  cursor: pointer;
...
.gm-result--fail { border-left: 3px solid var(--color-accent-fear, #c84b31); }
...
.gm-result__badge--miss { background: var(--color-accent-fear, #c84b31); color: #fff; }
