...
describe('HomebrewHub', () => {
  ...
  describe('liens de navigation', () => {
    it('les liens Voir pointent vers les routes de liste', () => {
      ...
      expect(hrefs).toContain('/edition/homebrew/adversary')
      expect(hrefs).toContain('/edition/homebrew/ancestry')
      expect(hrefs).toContain('/edition/homebrew/class')
      expect(hrefs).toContain('/edition/homebrew/community')
      expect(hrefs).toContain('/edition/homebrew/domain')
      expect(hrefs).toContain('/edition/homebrew/environment')
      expect(hrefs).toContain('/edition/homebrew/equipment')
    })
    ...
    it('les liens Créer pointent vers les routes de création', () => {
      ...
      expect(hrefs).toContain('/edition/homebrew/adversary/new')
      expect(hrefs).toContain('/edition/homebrew/ancestry/new')
      expect(hrefs).toContain('/edition/homebrew/class/new')
      expect(hrefs).toContain('/edition/homebrew/community/new')
      expect(hrefs).toContain('/edition/homebrew/domain/new')
      expect(hrefs).toContain('/edition/homebrew/environment/new')
      expect(hrefs).toContain('/edition/homebrew/equipment/new')
    })
  })
