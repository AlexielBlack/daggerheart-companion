...
describe('HomebrewHub', () => {
  ...
  describe('liens de navigation', () => {
    it('les liens Voir pointent vers les routes de liste', () => {
      ...
      expect(hrefs).toContain('/compendium/adversaires')
      expect(hrefs).toContain('/compendium/ascendances')
      expect(hrefs).toContain('/compendium/classes')
      expect(hrefs).toContain('/compendium/communautes')
      expect(hrefs).toContain('/compendium/domaines')
      expect(hrefs).toContain('/compendium/environnements')
      expect(hrefs).toContain('/compendium/equipement')
    })
    ...
    it('les liens Créer pointent vers les routes de création', () => {
      ...
      expect(hrefs).toContain('/compendium/adversaires/new')
      expect(hrefs).toContain('/compendium/ascendances/new')
      expect(hrefs).toContain('/compendium/classes/new')
      expect(hrefs).toContain('/compendium/communautes/new')
      expect(hrefs).toContain('/compendium/domaines/new')
      expect(hrefs).toContain('/compendium/environnements/new')
      expect(hrefs).toContain('/compendium/equipement/new')
    })
  })
